...
class AgencyPaymentController extends Controller
{
    ...
    public function updateStatus(Request $request){
        ...
        if($validator->fails()){
           return $this->error('Oops! Failed To Save Payment Details'.$validator->errors()->first(), null, null, 500);
        }else{
            try{
                ...
                return $this->error('Oops! Something Went Wrong. Failed To Save Payment Details', null, null, 500);
            }
        }
    }
}
