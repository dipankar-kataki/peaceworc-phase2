...
class ProfileRegistrationController extends Controller
{
    ...
    public function getProfileDetails(){
        $details = AgencyProfileRegistration::with('profileCompletionStatus')->withCount('job_count as job_count', 'rating_count as rating_count')->withSum('revenue_count as revenue_count', 'amount')->where('user_id', Auth::user()->id)->first();
