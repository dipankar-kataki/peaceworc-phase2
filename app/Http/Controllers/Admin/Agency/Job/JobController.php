...
class JobController extends Controller
{
    public function getAllJobs($id = null){
        ...
        if($id === null){
            ...
            return view('admin.agency.job.list')->with(['get_all_jobs' => $get_all_jobs]);
        }else{
            $job_id = decrypt($id);
            ...
            return view('admin.agency.job.job-details')->with(['get_single_job_details' => $get_single_job_details, 'is_profile_approved' => $is_profile_approved->is_profile_approved ]);
        }
