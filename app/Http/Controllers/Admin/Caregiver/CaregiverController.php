...
class CaregiverController extends Controller
{
    public function getList(Request $request){
        ...
        return view('admin.caregiver.profile.index')->with(['get_caregiver_details' => $get_caregiver_details]);
    }
    ...
    public function getCaregiverDetails($id){
        try{
            ...
            return view('admin.caregiver.profile.details')->with(['get_caregiver_details' => $get_caregiver_details]);
        }catch(\Exception $e){
