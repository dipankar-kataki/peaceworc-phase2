            ...
            if($_GET['id'] == 0){
                ...
                foreach($get_jobs as $job){
                    ...
                    $details = [
                        ...
                        'amount' => $job->amount,
                        'address' => ($job->appartment_or_unit != null ? $job->appartment_or_unit.', ' : '').''.($job->floor_no != null ? $job->floor_no.', ' : '').''.($job->address),
                ...
                $miles = $this->jobDistance($lat1, $long1, $lat2, $long2, 'M');
                    ...
                    $details = [
                        ...
                        'address' => ($get_jobs->appartment_or_unit != null ? $get_jobs->appartment_or_unit.', ' : '').''.($get_jobs->floor_no != null ? $get_jobs->floor_no.', ' : '').''.($get_jobs->address),
