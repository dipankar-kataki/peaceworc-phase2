function getChartColorsArray(o) {
  if (null !== document.getElementById(o)) {
    var t = document.getElementById(o).getAttribute('data-colors')
    if (t)
      return (t = JSON.parse(t)).map(function (o) {
        var t = o.replace(' ', '')
        return -1 === t.indexOf(',')
...
function generateData(o, t) {
  for (var e = 0, a = []; e < o; ) {
    var r = 'w' + (e + 1).toString(),
          ...
          labels: {
            ...
            total: {
              ...
              formatter: function (o) {
                return (
                  '$' +
                  o.globals.seriesTotals.reduce(function (o, t) {
                    return o + t
                  }, 0)
                )
              },
