<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index.html" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="/assets/images/logo/logo.png" alt="" height="90">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="index.html" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="/assets/images/logo/logo-white.png" alt="" height="90">
            </span>
        </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="agencyItems">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.agency.get.all.job')}}" class="{{Request::segment(3) == 'list' ? 'nav-link menu-link active' : 'nav-link menu-link'}}">Jobs Posted</a>
                            </li>
                        </ul>
                    </div>
                </li>
